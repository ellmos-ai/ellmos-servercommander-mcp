...
- `sc_deploy`: creates a deployment plan with a local SHA256 manifest and profile diagnostics, but does not upload yet; readiness now checks required fields, manifestable local paths, and supported protocols before optional `record_history=true`
